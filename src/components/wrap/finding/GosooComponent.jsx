...
export default function GosooComponent() {
  ...
  if(gosooData!==undefined && gosooData !==null){
    ...
    <div className="header-img-box" style={{backgroundImage: `url(./images/finding/gosoo/${gosooData.profile_img_name})`}}></div>
        ...
        <div className="content">
          <div className="row1">
            <div className="brand-img-box" >
              <div className="img-border-gap" style={{backgroundImage: `url(./images/finding/gosoo/${gosooData.profile_img_name})`}}></div>
            </div>
          </div>
          <div className="row2">
            <div className="col1">
